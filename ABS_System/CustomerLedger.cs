...
namespace Accounting_System
{
    public partial class CustomerLedger : Form
    {
        ...
        private void fillCustomer()
        {
            try
            {
                using (SqlConnection con = new SqlConnection(DataAccessLayer.Con()))
                {
                    ...
                    {
                        adp.SelectCommand = new SqlCommand("SELECT RTRIM(CustomerName) FROM Customers ", con);
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(DataAccessLayer.Con()))
                {
                    ...
                    string customerQuery = "SELECT RTRIM(Address), RTRIM(Email), RTRIM(PhoneNumber) FROM Customers WHERE CustomerID = @d1";
                    ...
                    string query1 = "SELECT Date, Name, LedgerNo, Label, Credit, Debit, Manual_Inv FROM LedgerBook WHERE Date Between @d1 AND @d2 AND PartyID = @d3 ORDER BY Date, LedgerNo ASC";
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            customerRecord2 frmCustomerRecord5 = new customerRecord2();


            frmCustomerRecord5.lblSet.Text = "CLedger";


            frmCustomerRecord5.Reset();


            frmCustomerRecord5.Show();
        ...
        private void cmbSupplierName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(DataAccessLayer.Con()))
                {
                    ...
                    {
                        cmd.CommandText = "SELECT RTRIM(CustomerID),RTRIM(Address), RTRIM(Email), RTRIM(PhoneNumber)  FROM Customers WHERE CustomerName=@d1";
