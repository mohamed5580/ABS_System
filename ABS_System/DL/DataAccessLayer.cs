    ...
    class DataAccessLayer
    {
        ...
        public static string Con()
        {
            ...
            /* string appDirectory = AppDomain.CurrentDomain.BaseDirectory;
             string databasePath = Path.Combine(appDirectory, "ABS_SYSTEM.mdf");
             if (Accounting_System.Properties.Settings.Default.Mode == true)
             {
                 return $"Server=(localdb)\\MSSQLLocalDB;AttachDbFilename={databasePath};Integrated Security=True;Connect Timeout=30;";
             }*/
            else
            {
